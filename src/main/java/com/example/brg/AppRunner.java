...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        userRepository.save(new User("test1", encoder.encode("aaaaaaaaaaB.1"), "Mr.Kim"));
        userRepository.save(new User("test2", encoder.encode("aaaaaaaaaaB.1"), "Mr.Park"));
        userRepository.save(new User("test3", encoder.encode("aaaaaaaaaaB.1"), "Mr.Lee"));
        ...
        for (int i = 1; i <= deliveryCount; i++) {
            deliveryRepository.save(
                    new Delivery(test1,
                            LocalDateTime.of(2023, 1, i, 0, 0),
                            LocalDateTime.of(2023, 1, i, 0, 0),
                            "samsung-dong", DeliveryStatus.ARRIVED));

            deliveryRepository.save(
                    new Delivery(test2,
                            LocalDateTime.of(2023, 2, i, 0, 0),
                            LocalDateTime.of(2023, 2, i, 0, 0),
                            "seocho-dong",
